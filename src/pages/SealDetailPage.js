...
const SealDetailPage = () => {
    ...
    const loadSealDetail = async () => {
        setLoading(true);
        try {
            const sealData = await getSeal(parseInt(id));
            if (sealData) {
                try {
                ...
                >
                    <div className="seal-header">
                        <div className="seal-status-section">
                            ...
                            <div className="seal-id">封印 #{seal.id}</div>
                        </div>
                            ...
                            <div className="content-text">
                                {seal.isUnlocked ? (
                                    ...
                                    <div className="locked-content">
                                        <Lock size={48} />
                                        <p>内容已被时间锁定，请等待解锁时间到达</p>
                                    </div>
                                )}
                            </div>
                        </div>

                        {seal.isUnlocked && seal.mediaIds && (
